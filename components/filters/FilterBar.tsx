...
import { Filter, User, Building2, Stethoscope, Calendar, ChevronDown } from 'lucide-react'
...
export default function FilterBar({ onFilterChange }: FilterBarProps) {
  ...
  }, [startDate, endDate, selectedOwners, selectedSpecialties, selectedCompanyTypes, includeRemoved, tier1Only, preset]) // eslint-disable-line
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
      ...
      <div className="px-5 py-3 bg-gray-50 border-t border-gray-200 flex flex-wrap items-center justify-between gap-4">
